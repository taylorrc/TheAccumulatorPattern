...
def run_test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(3, 4, 0.29)
    ...
    expected = 3
    answer = count_cosines_from(3, 9, 0.0)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 2.0833333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 4)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.3361111  # This is APPROXIMATELY the correct answer.
